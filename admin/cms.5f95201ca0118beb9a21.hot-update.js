    ...
    if (mediaPath) {
      ...
      this.editor.model.change(function (writer) {
        var imageElement = writer.createElement('image', {
          src: mediaPath // `${getAsset(mediaPath).url}`,

        });

        _this2.props.onRemoveMediaControl(id);

        writer.setAttribute('data-media-path', mediaPath, imageElement); // Insert the image in the current selection location.
...
//# sourceMappingURL=cms.5f95201ca0118beb9a21.hot-update.js.map